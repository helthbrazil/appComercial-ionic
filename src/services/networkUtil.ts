...
export class NetworkUtil {
    ...
    */
    listenDisconnected(callbackDisconnected) {
        var disconnectSubscription = this.network.onDisconnect().subscribe(() => {
            callbackDisconnected(disconnectSubscription);
        });
    }
    ...
    */
    listenConnected(callbackConnected) {
        var connectSubscription = this.network.onConnect().subscribe(() => {
            callbackConnected(connectSubscription);
        });
    }
